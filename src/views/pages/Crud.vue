            ...
            <div class="card">
                <Toolbar class="mb-4">
                    <template v-slot:start>
                        <div class="my-2">
                            <Button label="Ajouter un établissement" icon="pi pi-plus" class="mr-2" severity="success"
                                @click="openNew" />
                        </div>
                    </template>

                    <template v-slot:end>
                        <Button label="Supprimer" icon="pi pi-trash" severity="danger" @click="confirmDeleteSelected"
                ...
                <DataTable ref="dt" :value="products" v-model:selection="selectedProducts" dataKey="id"
                    ...
                    <template #header>
                        <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                            <h5 class="m-0">Mes établissements</h5>
                    ...
                    <Column field="name" header="Nom de l'établissemnt" :sortable="true"
                        headerStyle="width:20%; min-width:10rem;">
                        <template #body="slotProps">
                            <span class="p-column-title">Nom de l'établissemnt</span>
                        </template>
                    </Column>
                    <Column header="Logo" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                ...
                <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details"
                    ...
                    <template #footer>
                        ...
                        <Button label="Enregistrer" icon="pi pi-check" text="" @click="saveProduct" />
                    </template>
                </Dialog>
                ...
                <Dialog v-model:visible="deleteProductDialog" :style="{ width: '450px' }" header="Confirm"
                    ...
                    <div class="flex align-items-center justify-content-center">
                        ...
                        <span v-if="product">Voulez-vous confirmer la suppression de <b>{{ product.name }}</b>?</span>
                    </div>
                    <template #footer>
                        <Button label="Non" icon="pi pi-times" text @click="deleteProductDialog = false" />
                        <Button label="Oui" icon="pi pi-check" text @click="deleteProduct" />
                    </template>
                </Dialog>
                ...
                <Dialog v-model:visible="deleteProductsDialog" :style="{ width: '450px' }" header="Confirm"
                    ...
                    <div class="flex align-items-center justify-content-center">
                        <i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />
                        <span v-if="product">Voulez-vous supprimer les établissments sélectionnés ?</span>
                    </div>
                    <template #footer>
