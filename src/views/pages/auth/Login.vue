...
<template>
    ...
    <div class="grid grid-nogutter surface-section text-800">
                ...
                <div
                    ...
                    <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                        <div class="text-center mb-5">
                            <span class="block text-5xl font-bold mb-3"> <span style="color: var(--primary-color)">Se
                                    connecter</span> </span>
                            <span class="text-600 font-medium">Entrez vos informations pour vous connecter à
                                <b>Rushup</b>.</span>
                        </div>
                        ...
                        <div>
                            ...
                            <Password id="password1" v-model="password" placeholder="Mot de passe" :toggleMask="true"
                            ...
                            <Button type="submit" label="Se connecter" class="w-full p-2 text-md mb-3"></Button>
                            <hr>

                            <div class="flex" style="justify-content: center; margin-top:25px; font-weight:bold;">
                                <span>Vous n'avez pas de compte ?
                                    <router-link to="/auth/singup"
                                        style="color: var(--primary-color); text-decoration: underline;"> <span>
                                            Inscrivez-vous</span>
                                    </router-link>
                                </span>
        ...
        <div class=" col-12 md:col-6 overflow-hidden">
            <img src="/layout/images/hero-1.png" alt="Image" class="md:ml-auto block md:h-full"
